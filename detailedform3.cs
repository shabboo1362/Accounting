...
{
	/// <summary>
	/// Summary description for detailedform3.
	/// </summary>
	public class detailedform3 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.panel5.Size = new System.Drawing.Size(376, 30);
			this.panel5.TabIndex = 22;
			this.panel5.Visible = false;
			// 
			// generaltxt
			// 
			this.generaltxt.Location = new System.Drawing.Point(240, 0);
			...
			this.generalcmd.Location = new System.Drawing.Point(344, 0);
			...
			this.label1.Text = ": ⁄ÌÌ‰ òœ Õ”«»  ›’Ì·Ì 3";
			// 
			// limitbox
			// 
			...
			this.panel4.Size = new System.Drawing.Size(376, 30);
			this.panel4.TabIndex = 21;
			this.panel4.Visible = false;
			// 
			// subsidiarytxt
			// 
			this.subsidiarytxt.Location = new System.Drawing.Point(240, 0);
			...
			this.subsidiarycmd.Location = new System.Drawing.Point(344, 0);
			...
			this.dataGridTableStyle3.MappingName = "DetailedCode3";
			...
			this.dcancelcmd.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.dcancelcmd.TabIndex = 1;
			this.dcancelcmd.Text = "«‰’—«›";
			this.dcancelcmd.Click += new System.EventHandler(this.dcancelcmd_Click_1);
			// 
			// groupBox1
			// 
			...
			this.dataGridTextBoxColumn3.MappingName = "SubsidiaryCode";
			...
			this.dataGridTextBoxColumn4.MappingName = "SubsidiaryName";
			...
			this.dataGridTextBoxColumn5.MappingName = "SubsidiaryDescription";
			...
			this.dataGridTextBoxColumn6.MappingName = "DetailedCode3";
			...
			this.dataGridTextBoxColumn7.MappingName = "DetailedName";
			...
			this.dataGridTextBoxColumn8.MappingName = "DetailedDescription";
			...
			this.Name = "detailedform3";
			this.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "ê“Ì‰‘ œ› —  ›’Ì·Ì 3";
			this.Load += new System.EventHandler(this.detailedform3_Load);
		...
		private void subsidiarycmd_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				ob.get_Info("*","DetailedCode3 INNER JOIN (DetailedCode2 INNER JOIN (Subsidiary INNER JOIN DetailedCode1 ON Subsidiary.SubsidiaryCode=DetailedCode1.SubsidiaryCode)on DetailedCode1.DetailedCode1=DetailedCode2.DetailedCode1)on DetailedCode3.DetailedCode2=DetailedCode2.DetailedCode2 ","DetailedCode3='"+detailedcodetxt.Text+"'",dataset,"Subsidiary");
				dataGrid1.DataSource=dataset;
		...
		private void generalcmd_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				ob.get_Info("*","General INNER JOIN (DetailedCode3 INNER JOIN(DetailedCode2 INNER JOIN (Subsidiary INNER JOIN DetailedCode1 ON Subsidiary.SubsidiaryCode=DetailedCode1.SubsidiaryCode)on DetailedCode1.DetailedCode1=DetailedCode2.DetailedCode1)on DetailedCode3.DetailedCode2=DetailedCode2.DetailedCode2)ON Subsidiary.GeneralCode=General.GeneralCode  ","DetailedCode3='"+detailedcodetxt.Text+"'",dataset,"General");
				dataGrid1.DataSource=dataset;
		...
		private void dcancelcmd_Click_1(object sender, System.EventArgs e)
		{
			groupBox1.Visible=false;
		}
		...
		private void detailedcodetxt_Validated(object sender, System.EventArgs e)
		{
			if(detailedcodetxt.Text!="")
			{
				if(ob.get_ID("DetailedCode3","DetailedCode3","DetailedCode3='"+detailedcodetxt.Text+"'")==0)
				{
		...
		private void subsidiarytxt_Validated(object sender, System.EventArgs e)
		{
			...
			{
			if(ob.get_ID("Subsidiary.SubsidiaryCode","DetailedCode3 INNER JOIN (DetailedCode2 INNER JOIN (Subsidiary INNER JOIN DetailedCode1 ON Subsidiary.SubsidiaryCode=DetailedCode1.SubsidiaryCode)on DetailedCode1.DetailedCode1=DetailedCode2.DetailedCode1)on DetailedCode3.DetailedCode2=DetailedCode2.DetailedCode2 ","DetailedCode3='"+detailedcodetxt.Text+"' AND Subsidiary.SubsidiaryCode='"+subsidiarytxt.Text+"'")==0)
				 {
					 MessageBox.Show("òœ Ê—ÊœÌ „⁄ »— ‰„Ì»«‘œ","Œÿ«",MessageBoxButtons.OK,MessageBoxIcon.Error);	
					 subsidiarytxt.Text="";
					 subsidiarytxt.Focus();
		...
		private void generaltxt_Validated(object sender, System.EventArgs e)
		{
			...
			{
			if(ob.get_ID("General.GeneralCode","General INNER JOIN (DetailedCode3 INNER JOIN(DetailedCode2 INNER JOIN (Subsidiary INNER JOIN DetailedCode1 ON Subsidiary.SubsidiaryCode=DetailedCode1.SubsidiaryCode)on DetailedCode1.DetailedCode1=DetailedCode2.DetailedCode1)on DetailedCode3.DetailedCode2=DetailedCode2.DetailedCode2)ON Subsidiary.GeneralCode=General.GeneralCode","DetailedCode3='"+detailedcodetxt.Text+"' AND General.GeneralCode='"+generaltxt.Text+"'")==0)
				 {
					 MessageBox.Show("òœ Ê—ÊœÌ „⁄ »— ‰„Ì»«‘œ","Œÿ«",MessageBoxButtons.OK,MessageBoxIcon.Error);	
					 generaltxt.Text="";
					 generaltxt.Focus();
		...
		private void detailedform3_Load(object sender, System.EventArgs e)
		{
			detailedcodetxt.Focus();
		}
		...
		private void submitcmd_Click(object sender, System.EventArgs e)
		{
			...
			{
				reports form=new reports("Detailed3",fcode,"",limit,fdate1,tdate1,fnumber,tnumber,scode,ncode,document,sort);
				form.ShowDialog();
			}
		}
