...
{
	/// <summary>
	/// Summary description for subsidiarybalanceform.
	/// </summary>
	public class subsidiarybalanceform : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.submitcmd.Location = new System.Drawing.Point(344, 263);
			this.submitcmd.Name = "submitcmd";
			this.submitcmd.Size = new System.Drawing.Size(100, 30);
			this.submitcmd.TabIndex = 25;
			...
			this.cancelcmd.Location = new System.Drawing.Point(152, 263);
			this.cancelcmd.Name = "cancelcmd";
			this.cancelcmd.Size = new System.Drawing.Size(100, 30);
			this.cancelcmd.TabIndex = 26;
			this.cancelcmd.Text = "«‰’—«›";
			// 
			// panel2
			// 
			...
			this.comboDays.TextChanged += new System.EventHandler(this.fadte);
			// 
			// txtSetYear
			// 
			...
			this.txtSetYear.TextChanged += new System.EventHandler(this.fadte);
			// 
			// comboMonth
			// 
			...
			this.comboMonth.TextChanged += new System.EventHandler(this.fadte);
			// 
			// subsidiarybalanceform
			// 
			...
			this.Name = "subsidiarybalanceform";
		...
		private void fadte(object sender, System.EventArgs e)
		{
			...
			fdate1=Persia.Calendar.ConvertToGregorian(year, month, day).ToString();
		}
		...
		private void tdate(object sender, System.EventArgs e)
		{
			...
			tdate1=Persia.Calendar.ConvertToGregorian(year, month, day).ToString();
		}
	}
